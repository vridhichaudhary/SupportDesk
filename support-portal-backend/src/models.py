...
class Ticket(Base):
    ...
    internal_notes = relationship(
        "InternalNote", back_populates="ticket", cascade="all, delete-orphan"
    )
...
class TicketMessage(Base):
    ...
    __table_args__ = (Index("ix_message_ticket", "ticket_id"),)
...
class InternalNote(Base):
    ...
    __table_args__ = (Index("ix_internal_note_ticket", "ticket_id"),)
