...
def override_assignment_task(
    ...
    from src.models import ActionType, AssignmentHistory, AuditLog, Ticket, TicketStatus
...
def check_sla_breaches_task():
    ...
    """
    from src.models import ActionType, AuditLog, Ticket, TicketStatus
